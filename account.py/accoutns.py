class Account:
    ...
    def update_account_info(self, new_owner):
    ...
    def overdraft_limitation(self, overdraft_limit):
...
#     my_account = Account(account_owner="Dorcas Tuukuo", initial_balance=20000)
#     my_account.display_account_details()
#     my_account.update_account_info("Mary Jane")
